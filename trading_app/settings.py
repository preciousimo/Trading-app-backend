...
SECRET_KEY = 'django-insecure-fte6g0vvhcl)o7e049@9!%+b7t%u196%k+*5@wb6x7!$1l(7u1'
...
CELERY_BEAT_SCHEDULE = {
    'fetch_data_every_minute': {
        'task': 'trading.tasks.fetch_data',
        'schedule': 60.0,
    },
}

CSRF_TRUSTED_ORIGINS = ['https://trading-api.up.railway.app', 'http://localhost:8000', 'http://localhost:3000']